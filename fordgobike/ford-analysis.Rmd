...
df_transit = data.frame(name = c("Embarcadeo BART Station", 
                                 "SF Ferry Building", 
                                 "CalTrain Station", 
                        ...
                        system = c("BART", "FERRY", "CALTRAIN", rep("BART", 5)),
                        longitude = c(-122.397222, -122.3937, -122.394444, -122.401942, -122.408, -122.413498, -122.420042, -122.4187),
                        latitude = c(37.793056, 37.7955, 37.776389, 37.789355, 37.784, 37.779861, 37.764847, 37.752))
...
map_trips = function(hour, plot_title) {
  ...
  ggmap(SFmap) +
    ...
    scale_color_discrete("Transit System")
      ggtitle(plot_title) +
    theme_void()
}
```
