...
Finally, let's compare the bike trips at 8 AM and 5 PM:
...
I am grateful for those who have made it to the end of this lengthy tutorial. I had an absolute blast probing the data on the San Francisco Bay Area bide share system under the microscope. 

I encourage those galvanized by this work to explore on their own. Ford GoBike has a cousin called [Citi Bike](https://www.citibikenyc.com/system-data) that operates in New York City. The system in Big Apple is more established and its data date back to 2013, which means more data to play with.
